            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-12 py-3 bg-white/20 border border-white/30 rounded-lg text-black placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/50"
                    />
                    <button
                      type="button"
                ...
                <button
                  disabled={isLoading}
                  type="submit"
                  className="w-full px-6 py-4 bg-white/30 border-2 border-white/40 rounded-xl text-white text-base sm:text-lg hover:bg-white/40 disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isLoading ? (
                    <>
