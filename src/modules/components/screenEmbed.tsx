...
export function ScreenEmbed({ initialView }: { initialView?: string }) {
  ...
  const getButtonClass = (view: string) =>
    `px-4 py-2 text-sm text-white rounded-lg transition-all font-medium ${
      currentView === view
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header className="flex items-center justify-between w-full px-4 sm:px-6 lg:px-8 py-3">
          <button
            onClick={() => {
              setShowUserType(false);
              setShowQuestionnaire(false);
          ...
          <div className="lg:hidden relative" ref={menuRef}>
            ...
            {isMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-64 bg-gray-900/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-4 z-50">
                {/* Langues */}
                    ...
                    {(["spanish", "english", "catalan"] as Language[]).map(
                      (lang) => (
                        <button
                          ...
                          className={`text-xs px-2 py-2 rounded-xl transition-all font-medium ${
                            language === lang
                ...
                <div className="space-y-1.5">
                  ...
                  {!isLoggedIn ? (
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-3 text-sm text-white/90 hover:bg-white/10 rounded-xl transition-colors font-medium"
                    >
                      📊 Dashboard
                    </button>
                  )}
          ...
          <nav className="hidden lg:flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`${
                  currentView === "home"
                    ? "bg-purple-500/60 text-white font-semibold shadow-lg px-4 py-2 text-sm  backdrop-blur-md border border-white/20 rounded-lg hover:hover:bg-purple-500/80 transition-all"
                    : "px-4 py-2 text-sm text-white/90 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-all font-medium"
                }`}
              >
                Home
              </button>
              <button
                ...
                className={`${
                  currentView === "question"
                    ? "bg-purple-500/60 text-white font-semibold shadow-lg px-4 py-2 text-sm  backdrop-blur-md border border-white/20 rounded-lg hover:hover:bg-purple-500/80 transition-all flex items-center gap-2"
                    : "px-4 py-2 text-sm text-white/90 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-all font-medium flex items-center gap-2"
                }`}
              >
                Test Group
                <svg
              ...
              <button
                ...
                className={`${
                  currentView === "signup"
                    ? "bg-purple-500/60 text-white font-semibold shadow-lg px-4 py-2 text-sm  backdrop-blur-md border border-white/20 rounded-lg hover:bg-purple-500/80 transition-all  flex items-center gap-2"
                    : "px-4 py-2 text-sm text-white/90 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-all font-medium flex items-center gap-2"
                }`}
              >
                <svg
              ...
              {!isLoggedIn ? (
                <button
                  ...
                  className="px-4 py-2 text-sm text-white bg-white/20 backdrop-blur-md border border-white/30 rounded-lg hover:bg-white/30 transition-all font-medium"
                >
                  {loginText[language]}
                </button>
              ) : (
                <button
                  ...
                  className="px-4 py-2 text-sm text-white bg-white/20 backdrop-blur-md border border-white/30 rounded-lg hover:bg-white/30 transition-all font-medium flex items-center gap-2"
                >
                  <svg
                    width="14"
                    height="14"
        ...
        {/* CONTENU PRINCIPAL */}
        <main className="flex-1 w-full overflow-y-auto overscroll-contain px-4 sm:px-6 lg:px-8 pb-6">
          <div className="relative w-full max-w-7xl mx-auto flex flex-col items-center gap-6 md:gap-10">
                ...
                <div className="flex-1 relative bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-blue-500/20 flex items-center justify-center p-4 sm:p-6 md:p-8">
                  {showUserType ? (
                    ...
                    <div className="text-center text-white space-y-4 sm:space-y-6 px-2 sm:px-4 w-full">
                      ...
                      {/* MEDIA CARD */}
                      <div className="mt-4 sm:mt-8 bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-6 max-w-md mx-auto border border-white/20 relative">
                        {/* Arrow Left */}
                        {canScrollLeft && (
                          <button
                            type="button"
                            onClick={() => scrollByAmount(-300)}
                            className="hidden sm:flex items-center justify-center absolute left-2 top-1/2 -translate-y-1/2 bg-black/40 text-white p-2 rounded-full backdrop-blur-md shadow-md hover:bg-black/60 transition-all z-10"
                        ...
                        {canScrollRight && (
                          <button
                            type="button"
                            onClick={() => scrollByAmount(300)}
                            className="hidden sm:flex items-center justify-center absolute right-2 top-1/2 -translate-y-1/2 bg-black/40 text-white p-2 rounded-full backdrop-blur-md shadow-md hover:bg-black/60 transition-all z-10"
            ...
            {/* Magazine Button */}
            <div className="flex justify-start w-full max-w-4xl mt-6 sm:mt-10">
              <button
