          ...
          <div className="flex gap-3 sm:gap-4 mb-4 sm:mb-6 overflow-x-auto pb-1">
            {[
              ...
              <button
                ...
                className={`cursor-pointer flex items-center gap-1 px-4 py-3 rounded-lg transition-all whitespace-nowrap ${
                  activeTab === id
            ...
            <button
              ...
              className="bg-white/30 backdrop-blur-md border-2 border-white/50
