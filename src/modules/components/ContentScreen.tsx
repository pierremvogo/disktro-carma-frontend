...
import backgroundImage from "figma:asset/4ac3eed398bb68113a14d0fa5efe7a6def6f7651.png";
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          >
            <div className="flex justify-center gap-6" role="group">
              <button
                ...
                className={`text-white drop-shadow hover:opacity-70 transition-opacity underline focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-transparent rounded px-2 py-1 ${
                  language === "spanish"
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            <p
              className="text-white drop-shadow text-lg"
              role="status"
              aria-live="polite"
            >
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md border border-white/30 rounded-lg text-white drop-shadow hover:bg-white/30 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500"
                aria-label={
                  language === "spanish"
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white/30 backdrop-blur-md border border-white/40 rounded-lg text-white drop-shadow hover:bg-white/40 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500"
